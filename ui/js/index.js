...
catch(e){if(ld)ld.classList.add('hidden');var errEl=document.getElementById(mode+'-error');if(errEl){errEl.classList.remove('hidden');errEl.innerHTML='<div class="card" style="border-color:var(--red);padding:var(--space-3)"><p style="color:var(--red);font-weight:600;margin:0">'+esc((e&&e.message)||String(e))+'</p></div>';}}
}
