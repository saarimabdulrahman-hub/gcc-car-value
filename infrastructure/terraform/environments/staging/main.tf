# =============================================================================
# Staging Environment — Pre-production validation on AWS
# =============================================================================
...
module "ecs" {
  ...
  api_container_image     = "${module.ecr.api_repository_url}:staging"
  scraper_container_image = "${module.ecr.scraper_repository_url}:staging"
