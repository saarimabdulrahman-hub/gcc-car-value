# =============================================================================
# Dev Environment — Shared sandbox on AWS
# =============================================================================
...
module "secrets" {
  ...
  environment    = var.environment
  database_url   = var.db_password != null ? "postgresql+asyncpg://${var.db_username}:${var.db_password}@${module.rds.address}:${module.rds.port}/${var.db_name}" : "placeholder"
...
module "ecs" {
  ...
  api_container_image      = "${module.ecr.api_repository_url}:latest"
  scraper_container_image  = "${module.ecr.scraper_repository_url}:latest"
